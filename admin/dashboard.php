    ...
    <div class="container">
        ...
        <div class="actions">
            ...
            <div style="display: flex; gap: 8px;">
                <a href="create-post.php" class="btn" style="background: linear-gradient(45deg, #f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%); display: flex; align-items: center; gap: 6px;">
