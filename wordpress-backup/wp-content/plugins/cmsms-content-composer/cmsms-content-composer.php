...
class Cmsms_Content_Composer { 
	function __construct() { 
		define('CMSMS_CONTENT_COMPOSER_VERSION', '1.4.8');
	...
	function cmsms_composer_enqueue_scripts($hook) {
		...
		/* Start Global Translations */
			...
			'choice_amount' => 									__('Amount', 'cmsms_content_composer'),
			'choice_image' => 									__('Image', 'cmsms_content_composer'),
			'choice_link' => 									__('Link', 'cmsms_content_composer'),
			'choice_campaign' => 								__('Campaign Name', 'cmsms_content_composer'),
			'choice_rest_amount' => 							__('Amount of donations still needed', 'cmsms_content_composer'),
			'choice_donated_percent' => 						__('Progress percent', 'cmsms_content_composer'),
			'choice_donation_but' => 							__('Donation button', 'cmsms_content_composer'),
		...
		/* Start cmsms_button Translations */
			...
			'button_field_type_title' =>						__('Button Type', 'cmsms_content_composer'),
			'choice_button_type_regular' =>						__('Regular Button', 'cmsms_content_composer'),
			'choice_button_type_donation' =>					__('Donation Button', 'cmsms_content_composer'),
			'button_field_campaign_title' =>					__('Donation Campaign', 'cmsms_content_composer'),
		...
		/* Start CMSMS Donations Extension Translations */
		
			/* Donations */
			'donations_title' =>								__('Donations', 'cmsms_content_composer'), 
			'donations_field_donations_number_title' =>			__('Number of Donations to Show', 'cmsms_content_composer'), 
			'donations_field_donations_number_descr_note' =>	__('Set 0 to show all donations', 'cmsms_content_composer'), 
			'donations_field_campaigns_title' =>				__('Campaigns', 'cmsms_content_composer'), 
			'donations_field_campaigns_descr' =>				__('Campaigns to show donations from', 'cmsms_content_composer'), 
			'donations_field_campaigns_descr_note' =>			__('Donations from all campaigns will be shown if none is selected', 'cmsms_content_composer'), 
			'donations_field_postsmeta_title' =>				__('Donations Meta to Display', 'cmsms_content_composer'), 
			
			/* Featured Campaign */
			'featured_campaign_title' =>						__('Featured Campaign', 'cmsms_content_composer'), 
			'featured_campaign_field_campaign_title' =>			__('Campaign to Show', 'cmsms_content_composer'), 
			'featured_campaign_field_postsmeta_title' =>		__('Campaign Meta to Display', 'cmsms_content_composer'), 
			
			/* Campaigns */
			'campaigns_title' =>								__('Campaigns', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_ids_title' =>			__('Campaigns', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_ids_descr' =>			__('Select one or several campaigns', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_ids_descr_note' =>		__('All campaigns will be shown if none is selected', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_categories_title' =>		__('Categories', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_categories_descr' =>		__('Select one or several categories to show campaigns from', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_categories_note' =>		__('Can be used only if \'Order By\' parameter is set to \'Date\' or \'Random\'. Select none to show all', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_number_title' =>			__('Number of Campaigns to Show', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_number_descr_note' =>	__('Set 0 to show all campaigns', 'cmsms_content_composer'), 
			'campaigns_field_pausetime_descr' =>				__('Enter your campaigns slider pause time', 'cmsms_content_composer'), 
			'campaigns_field_campaigns_metadata_title' =>		__('Campaigns Meta to Display', 'cmsms_content_composer'), 
			
		/* Finish CMSMS Donations Extension Translations */
		
		/* Start Timetable Extension Translations */
			
			'timetable_title' =>								__('Timetable', 'cmsms_content_composer'), 
			'timetable_field_event_title' =>					__('Events', 'cmsms_content_composer'), 
			'timetable_field_event_descr' =>					__('Select the events that are to be displayed in timetable', 'cmsms_content_composer'), 
			'timetable_field_event_descr_note' =>				__('Hold the CTRL key to select multiple items', 'cmsms_content_composer'), 
			'timetable_field_event_category_title' =>			__('Event categories', 'cmsms_content_composer'), 
			'timetable_field_event_category_descr' =>			__('Select the events categories that are to be displayed in timetable', 'cmsms_content_composer'), 
			'timetable_field_event_category_descr_note' =>		__('Hold the CTRL key to select multiple items', 'cmsms_content_composer'), 
			'timetable_field_hour_category_title' =>			__('Hour categories', 'cmsms_content_composer'), 
			'timetable_field_hour_category_descr' =>			__('Select the hour categories (if defined for existing event hours) for events that are to be displayed in timetable', 'cmsms_content_composer'), 
			'timetable_field_hour_category_descr_note' =>		__('Hold the CTRL key to select multiple items', 'cmsms_content_composer'), 
			'timetable_field_columns_title' =>					__('Columns', 'cmsms_content_composer'), 
			'timetable_field_columns_descr' =>					__('Select the columns that are to be displayed in timetable', 'cmsms_content_composer'), 
			'timetable_field_columns_descr_note' =>				__('Hold the CTRL key to select multiple items', 'cmsms_content_composer'), 
			'timetable_field_measure_title' =>					__('Hour measure', 'cmsms_content_composer'), 
			'timetable_field_measure_descr' =>					__('Choose hour measure for event hours', 'cmsms_content_composer'), 
			'timetable_field_measure_choice_hour' =>			__('Hour (1h)', 'cmsms_content_composer'), 
			'timetable_field_measure_choice_half_hour' =>		__('Half hour (30min)', 'cmsms_content_composer'), 
			'timetable_field_measure_choice_quarter_hour' =>	__('Quarter hour (15min)', 'cmsms_content_composer'), 
			'timetable_field_filter_style_title' =>				__('Filter style', 'cmsms_content_composer'), 
			'timetable_field_filter_style_descr' =>				__('Choose between dropdown menu and tabs for event filtering', 'cmsms_content_composer'), 
			'timetable_field_filter_style_choice_dropdown_list' =>	__('Dropdown list', 'cmsms_content_composer'), 
			'timetable_field_filter_style_choice_tabs' =>		__('Tabs', 'cmsms_content_composer'), 
			'timetable_field_filter_kind_title' =>				__('Filter kind', 'cmsms_content_composer'), 
			'timetable_field_filter_kind_descr' =>				__('Choose between filtering by events or events categories', 'cmsms_content_composer'), 
			'timetable_field_filter_kind_choice_event' =>		__('By event', 'cmsms_content_composer'), 
			'timetable_field_filter_kind_choice_event_category' =>	__('By event category', 'cmsms_content_composer'), 
			'timetable_field_filter_label_title' =>				__('Filter label', 'cmsms_content_composer'), 
			'timetable_field_filter_label_descr' =>				__('Specify text label for all events', 'cmsms_content_composer'), 
			'timetable_field_filter_label_def' =>				__('All Events', 'cmsms_content_composer'), 
			'timetable_field_time_format_title' =>				__('Time format', 'cmsms_content_composer'), 
			'timetable_field_time_format_choice_custom' =>		__('Custom', 'cmsms_content_composer'), 
			'timetable_field_time_format_custom_title' =>		__('Custom Time Format', 'cmsms_content_composer'), 
			'timetable_field_hide_all_events_view_title' =>		__('Hide \'All Events\' view', 'cmsms_content_composer'), 
			'timetable_field_hide_hours_column_title' =>		__('Hide first (hours) column', 'cmsms_content_composer'), 
			'timetable_field_show_end_hour_title' =>			__('Show end hour in first (hours) column', 'cmsms_content_composer'), 
			'timetable_field_event_layout_title' =>				__('Event block layout', 'cmsms_content_composer'), 
			'timetable_field_event_layout_descr' =>				__('Select one of the available event block layouts', 'cmsms_content_composer'), 
			'timetable_field_event_layout_choice_type' =>		__('Type', 'cmsms_content_composer'), 
			'timetable_field_hide_empty_title' =>				__('Hide empty rows', 'cmsms_content_composer'), 
			'timetable_field_disable_event_url_title' =>		__('Disable event url', 'cmsms_content_composer'), 
			'timetable_field_text_align_title' =>				__('Text align', 'cmsms_content_composer'), 
			'timetable_field_text_align_descr' =>				__('Specify text align in timetable event block', 'cmsms_content_composer'), 
			'timetable_field_id_title' =>						__('Id', 'cmsms_content_composer'), 
			'timetable_field_id_descr' =>						__('Assign a unique identifier to a timetable if you use more than one table on a single page', 'cmsms_content_composer'), 
			'timetable_field_id_descr_note' =>					__('Otherwise, leave this field blank', 'cmsms_content_composer'), 
			'timetable_field_row_height_title' =>				__('Row height', 'cmsms_content_composer'), 
			'timetable_field_box_bg_color_title' =>				__('Timetable box background color', 'cmsms_content_composer'), 
			'timetable_field_box_hover_bg_color_title' =>		__('Timetable box hover background color', 'cmsms_content_composer'), 
			'timetable_field_box_txt_color_title' =>			__('Timetable box text color', 'cmsms_content_composer'), 
			'timetable_field_box_hover_txt_color_title' =>		__('Timetable box hover text color', 'cmsms_content_composer'), 
			'timetable_field_box_hours_txt_color_title' =>		__('Timetable box hours text color', 'cmsms_content_composer'), 
			'timetable_field_box_hours_hover_txt_color_title' =>	__('Timetable box hours hover text color', 'cmsms_content_composer'), 
			'timetable_field_row1_bg_color_title' =>			__('Row 1 style background color', 'cmsms_content_composer'), 
			'timetable_field_row1_txt_color_title' =>			__('Row 1 style text color', 'cmsms_content_composer'), 
			'timetable_field_row2_bg_color_title' =>			__('Row 2 style background color', 'cmsms_content_composer'), 
			'timetable_field_row2_txt_color_title' =>			__('Row 2 style text color', 'cmsms_content_composer'), 
	...
	// CMSMasters Editor Shortcodes	Translations
		...
		wp_localize_script('cmsms_composer_lightbox_js', 'cmsms_lightbox', array( 
			'palettes' => 				((function_exists('cmsms_color_picker_palettes')) ? implode(',', cmsms_color_picker_palettes()) : ''), 
