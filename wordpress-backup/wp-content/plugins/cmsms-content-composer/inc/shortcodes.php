...
function cmsms_button($atts, $content = null) {
	...
	if ($button_type == 'donation') {
		...
		if ($button_campaign != '') {
			$link = add_query_arg('campaign_id', urlencode($button_campaign), get_permalink($cmsms_donations_form_page));
		} else {
			$link = get_permalink($cmsms_donations_form_page);
		}
	} else {
		$link = $button_link;
	}
	...
	if ($content != null) {
		if ($layout == 'hover') {
			...
			foreach ($images as $image) {
				...
				$gallery_item = '<li class="cmsms_gallery_item' . ((get_post_field('post_excerpt', $image) != '') ? ' cmsms_caption' : '') . '">' . 
					'<figure>';
 ...
 * Timetable
 */
function cmsms_timetable($atts, $content = null) {
    $new_atts = apply_filters('cmsms_timetable_atts_filter', array( 
		'event' => 						'', 
		'event_category' => 			'', 
		'hour_category' => 				'', 
		'columns' => 					'', 
    ...
    $out = '<div id="cmsms_timetable_shortcode_' . $unique_id . '" class="cmsms_timetable_shortcode' . 
	(($classes != '') ? ' ' . $classes : '') . 
	'">';
	
	$out .= "
	<style type=\"text/css\">
		#cmsms_timetable_shortcode_{$unique_id} .tabs_box_navigation .tabs_box_navigation_selected {
			" . cmsms_color_css('color', $box_txt_color) . "
			" . cmsms_color_css('background-color', $box_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} .tabs_box_navigation .tabs_box_navigation_selected .sub-menu {
			" . cmsms_color_css('background-color', $row1_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} .tabs_box_navigation .tabs_box_navigation_selected .sub-menu li a {
			" . cmsms_color_css('color', $row1_txt_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} .tabs_box_navigation .tabs_box_navigation_selected .sub-menu li a:hover, 
		#cmsms_timetable_shortcode_{$unique_id} .tabs_box_navigation .tabs_box_navigation_selected .sub-menu li.selected a {
			" . cmsms_color_css('color', $box_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} .tt_tabs_navigation li a {
			" . cmsms_color_css('color', $row2_txt_color) . "
			" . cmsms_color_css('border-color', $row1_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} .tt_tabs_navigation li a:hover,
		#cmsms_timetable_shortcode_{$unique_id} .tt_tabs_navigation li a.selected,
		#cmsms_timetable_shortcode_{$unique_id} .tt_tabs_navigation li.ui-tabs-active a {
			" . cmsms_color_css('border-color', $box_bg_color) . "
		}
		
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable tr.row_gray {
			" . cmsms_color_css('color', $row1_txt_color) . "
			" . cmsms_color_css('background-color', $row1_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable tr {
			" . cmsms_color_css('color', $row2_txt_color) . "
			" . cmsms_color_css('background-color', $row2_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event {
			" . cmsms_color_css('background-color', $box_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event hr {
			" . cmsms_color_css('background-color', $box_txt_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event {
			" . cmsms_color_css('background-color', $box_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container:hover, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event:hover, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_tooltip_content {
			" . cmsms_color_css('background-color', $box_hover_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event .event_container, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event .event_container:hover {
			background-color:transparent;
			color:inherit;
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_tooltip_arrow {
			" . cmsms_color_css('border-color', $box_hover_bg_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container a, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event a {
			" . cmsms_color_css('color', $box_txt_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container:hover, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container:hover a, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event:hover, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event:hover a, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_tooltip_content, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_tooltip_content a {
			" . cmsms_color_css('color', $box_hover_txt_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container .hours, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event .hours {
			" . cmsms_color_css('color', $box_hours_txt_color) . "
		}
		
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .event_container:hover .hours, 
		#cmsms_timetable_shortcode_{$unique_id} table.tt_timetable .tt_single_event:hover .hours {
			" . cmsms_color_css('color', $box_hours_hover_txt_color) . "
		}
	</style>";
...
add_shortcode('cmsms_timetable', 'cmsms_timetable');
